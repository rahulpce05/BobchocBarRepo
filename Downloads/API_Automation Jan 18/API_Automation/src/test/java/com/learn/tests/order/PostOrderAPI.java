...
public class PostOrderAPI extends TestBase {
    ...
    public String postOrderAPI(RequestSpecBuilder builder, RequestSpecification requestSpec, Object payload) {
        builder.setBasePath("/api/Order");
        requestSpec = builder.build();
        jResponse = restClient.doPostRequest(requestSpec, payload).asString();
        return jResponse;
    }
